...
RM=rm
ARLIB = ar
FFOPT = -fbounds-check  -finit-local-zero 
...
ocnum.o:	numlib/ocnum.F90
	$(FF) -c  numlib/ocnum.F90

lmdif1lib.o:      numlib/lmdif1lib.F90
	$(FF) -c  numlib/lmdif1lib.F90  

gtp3.o:	models/gtp3.F90
	$(FF) -c  models/gtp3.F90

matsmin.o:	minimizer/matsmin.F90
	$(FF) -c  minimizer/matsmin.F90

smp2.o:		stepmapplot/smp2.F90
	$(FF) -c stepmapplot/smp2.F90

pmon6.o:	userif/pmon6.F90
	$(FF) -c  userif/pmon6.F90
